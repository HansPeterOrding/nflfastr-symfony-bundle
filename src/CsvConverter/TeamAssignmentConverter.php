...
class TeamAssignmentConverter extends AbstractCsvConverter implements TeamAssignmentConverterInterface
{
	...
	public static array $columnToTypeMapping = [
		TeamAssignmentConverterInterface::COLUMN_POSTEAM => TeamAssignmentInterface::TEAM_ASSIGNMENT_TYPE_POSESSION,
	...
	public static array $columnToYardsMapping = [
		...
		TeamAssignmentConverterInterface::COLUMN_FUMBLE_RECOVERY_1_TEAM => TeamAssignmentConverterInterface::COLUMN_FUMBLE_RECOVERY_2_YARDS,
