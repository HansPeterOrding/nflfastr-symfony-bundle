...
class PlayerAssignmentConverter extends AbstractCsvConverter implements PlayerAssignmentConverterInterface
{
	...
	public static array $columnToTypeMapping = [
		...
		PlayerAssignmentConverterInterface::COLUMN_SACK_PLAYER_ID                     => PlayerAssignmentInterface::PLAYER_ASSIGNMENT_TYPE_SACK,
		PlayerAssignmentConverterInterface::COLUMN_HALF_SACK_1_PLAYER_ID              => PlayerAssignmentInterface::PLAYER_ASSIGNMENT_TYPE_HALF_SACK,
		PlayerAssignmentConverterInterface::COLUMN_HALF_SACK_2_PLAYER_ID              => PlayerAssignmentInterface::PLAYER_ASSIGNMENT_TYPE_HALF_SACK,
