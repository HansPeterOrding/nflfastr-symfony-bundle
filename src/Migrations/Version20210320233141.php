...
final class Version20210320233141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT NOT NULL, abbreviation VARCHAR(3) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, status VARCHAR(30) NOT NULL, PRIMARY KEY(id))');
