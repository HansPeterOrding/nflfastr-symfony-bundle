 ...
 */
final class Version20201020065048 extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('CREATE TABLE player (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, birth_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, college VARCHAR(255) NOT NULL, high_school VARCHAR(255) NOT NULL, gsis_id VARCHAR(255) DEFAULT NULL, espn_id VARCHAR(255) DEFAULT NULL, sportradar_id VARCHAR(255) DEFAULT NULL, yahoo_id VARCHAR(255) DEFAULT NULL, rotowire_id VARCHAR(255) DEFAULT NULL, headshot_url VARCHAR(255) NOT NULL, last_updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, height_feet INT DEFAULT NULL, height_inches INT DEFAULT NULL, height_cm INT DEFAULT NULL, weight_pounds INT NOT NULL, weight_kilograms INT NOT NULL, PRIMARY KEY(id))');
		$this->addSql('COMMENT ON COLUMN player.birth_date IS \'(DC2Type:datetime_immutable)\'');
